    ...
    <section className="w-full py-20 bg-gray-50">
      <div className="max-w-6xl mx-auto px-6">
        ...
        <div className="bg-white rounded-3xl shadow-xl p-8 md:p-16 max-w-3xl mx-auto">
          <form 
            action="../actions/send" // Referencia la acción directamente
            method="POST"
          ...
          >
            ...
            <button
              type="submit"
              className="w-full bg-red-600 text-white font-bold py-3 px-6 rounded-xl shadow-lg hover:bg-red-500 transition"
            >
              Enviar Mensaje
            </button>
          </form>
